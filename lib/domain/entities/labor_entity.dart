...
List<LaborEntity> laborEntityFromJson(String str) => List<LaborEntity>.from(json.decode(str).map((x) => LaborEntity.fromJson(x)));

String laborEntityToJson(List<LaborEntity> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
