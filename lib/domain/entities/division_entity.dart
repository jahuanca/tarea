...
List<DivisionEntity> divisionEntityFromJson(String str) => List<DivisionEntity>.from(json.decode(str).map((x) => DivisionEntity.fromJson(x)));

String divisionEntityToJson(List<DivisionEntity> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
