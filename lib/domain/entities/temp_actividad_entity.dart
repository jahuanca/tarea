...
class TempActividadEntity {
  ...
  factory TempActividadEntity.fromJson(Map<String, dynamic> json) =>
      TempActividadEntity(
...
List<TempActividadEntity> tempActividadEntityFromJson(String str) =>
    List<TempActividadEntity>.from(
        json.decode(str).map((x) => TempActividadEntity.fromJson(x)));

String tempActividadEntityToJson(List<TempActividadEntity> data) =>
