...
class EsparragoAgrupaPersonalEntity {
    ...
    factory EsparragoAgrupaPersonalEntity.fromJson(Map<String, dynamic> json) => EsparragoAgrupaPersonalEntity(
        itemagruparpersonal: json["itemagruparpersonal"] == null ? null : json["itemagruparpersonal"],
    ...
    Map<String, dynamic> toJson() => {
        "itemagruparpersonal": itemagruparpersonal == null ? null : itemagruparpersonal,
...
List<EsparragoAgrupaPersonalEntity> esparragoAgrupaPersonalEntityFromJson(String str) => List<EsparragoAgrupaPersonalEntity>.from(json.decode(str).map((x) => EsparragoAgrupaPersonalEntity.fromJson(x)));

String esparragoAgrupaPersonalEntityToJson(List<EsparragoAgrupaPersonalEntity> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));