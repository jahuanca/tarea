...
class PersonalPreTareaEsparragoEntity {
  ...
  factory PersonalPreTareaEsparragoEntity.fromJson(Map<String, dynamic> json) =>
      PersonalPreTareaEsparragoEntity(
        itempersonalpretareaesparrago:
            json["itempersonalpretareaesparrago"] == null
                ? null
                : json["itempersonalpretareaesparrago"],
        fecha: json["fecha"] == null ? null : DateTime.parse(json["fecha"]),
        hora: json["hora"] == null ? null : DateTime.parse(json["hora"]),
        idSQLitePreTareaEsparrago: json["idSQLitePreTareaEsparrago"] == null
            ? null
            : json["idSQLitePreTareaEsparrago"],
        idestado: json["idestado"] == null ? null : json["idestado"],
        esperandoCierre:
            json["esperandoCierre"] == null ? null : json["esperandoCierre"],
        itempretareaesparragovarios: json["itempretareaesparragovarios"] == null
            ? null
            : json["itempretareaesparragovarios"],
        codigotkcaja:
            json["codigotkcaja"] == null ? null : json["codigotkcaja"],
        ...
        codigotkmesa:
            json["codigotkmesa"] == null ? null : json["codigotkmesa"],
        mesa: json["mesa"] == null ? null : json["mesa"],
        linea: json["linea"] == null ? null : json["linea"],
        correlativomesa:
            json["correlativomesa"] == null ? null : json["correlativomesa"],
        ...
        calibre: json['Calibre'] == null
            ? null
            : CalibreEntity.fromJson(json['Calibre']),
        viaEnvio: json['ViaEnvio'] == null
            ? null
            : ViaEnvioEntity.fromJson(json['ViaEnvio']),
        fechamod:
            json["fechamod"] == null ? null : DateTime.parse(json["fechamod"]),
      );

  Map<String, dynamic> toJson() => {
        "itempersonalpretareaesparrago": itempersonalpretareaesparrago == null
            ? null
            : itempersonalpretareaesparrago,
        "fecha": fecha == null
            ? null
        ...
        "idSQLitePreTareaEsparrago": idSQLitePreTareaEsparrago == null
            ? null
  ...
  Map<String, dynamic> toDB() => {
        ...
        "hora": hora == null ? null : hora.toIso8601String(),
        "idestado": idestado == null ? null : idestado,
        "id_pre_tarea_esparrago": idSQLitePreTareaEsparrago == null
            ? null
            : idSQLitePreTareaEsparrago,
        "key": key == null ? null : key,
        "esperandoCierre": esperandoCierre == null ? null : esperandoCierre,
...
List<PersonalPreTareaEsparragoEntity> personalPreTareaEsparragoEntityFromJson(
        String str) =>
    List<PersonalPreTareaEsparragoEntity>.from(json
        .decode(str)
        .map((x) => PersonalPreTareaEsparragoEntity.fromJson(x)));

String personalPreTareaEsparragoEntityToJson(
        List<PersonalPreTareaEsparragoEntity> data) =>
