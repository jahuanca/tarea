...
class ActividadEntity {
    ...
    factory ActividadEntity.fromJson(Map<String, dynamic> json) => ActividadEntity(
...
List<ActividadEntity> actividadEntityFromJson(String str) => List<ActividadEntity>.from(json.decode(str).map((x) => ActividadEntity.fromJson(x)));

String actividadEntityToJson(List<ActividadEntity> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));