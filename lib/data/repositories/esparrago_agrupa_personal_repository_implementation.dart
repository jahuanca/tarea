...
class EsparragoAgrupaPersonalRepositoryImplementation extends EsparragoAgrupaPersonalRepository {
  ...
  Future<List<EsparragoAgrupaPersonalEntity>> getAll() async {
    if (PreferenciasUsuario().offLine) {
      Box dataHive =
          await Hive.openBox<EsparragoAgrupaPersonalEntity>('esparrago_agrupa_sincronizar');
