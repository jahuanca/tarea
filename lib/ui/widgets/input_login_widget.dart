  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: error!=null ? dangerColor :  (PreferenciasUsuario().modoDark) ? primaryColorDark : primaryColor
        ),
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding: EdgeInsets.symmetric(horizontal: (icon!=null) ? size.width*0.13 : 0),
                        filled: true,
                        ...
                        hintText: texto,
                        hintStyle: (PreferenciasUsuario().modoDark) ? hintLoginStyleDark() : hintLoginStyle(),
                      ...
                      onChanged: onChanged,
                      textAlign: isTextArea  ? TextAlign.left : TextAlign.center,
                    ),
                  )
                ),
              ],
