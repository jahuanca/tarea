...
class ListadoPersonasPreTareaEsparragoPage extends StatelessWidget {
  
  final ListadoPersonasPreTareaEsparragoController controller =
      Get.find<ListadoPersonasPreTareaEsparragoController>();

  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;

    return GetBuilder<ListadoPersonasPreTareaEsparragoController>(
      init: controller,
          ...
          children: [
            Scaffold(
              ...
              body: RefreshIndicator(
                ...
                child: GetBuilder<ListadoPersonasPreTareaEsparragoController>(
                  id: 'seleccionado',
                  builder: (_) => Column(
                    children: [
            ...
            GetBuilder<ListadoPersonasPreTareaEsparragoController>(
              id: 'validando',
        ...
        builder: (_) => GestureDetector(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: 
                  _.personalSeleccionado[index]?.esperandoCierre ?? true ?
                  
                  Column(
                    children: [
                      Expanded(child: Container(
                        alignment: Alignment.centerRight,
                        child: IconButton(onPressed: () async=> _.goCancelarEsperando(index), icon: Icon(Icons.close, color: dangerColor)),
                      ), flex: 1),
                      Expanded(child: Container(
                      ...
                      Expanded(child: Container(
                        child: Text('Esperando etiqueta de cierre...', 
                          style: TextStyle(
                            color: Colors.black45,
                            fontSize: 12
                          ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Flexible(
                                child: Container(
                                  alignment: Alignment.centerLeft,
                                  child: Text(_.personalSeleccionado[index].labor?.descripcion ?? 'Sin descripción'),
                                ),
                                flex: 25,
                              ),
                              Flexible(child: Container(), flex: 1),
                          ...
                          child: Row(
                            children: [
                              ...
                              Flexible(
                                child: Container(
                                  alignment: Alignment.centerLeft,
                                  child: Text(_.personalSeleccionado[index].cliente.descripcion ?? 'Sin nombre'),
                                ),
                                flex: 10,
                              ),
                              Flexible(child: Container(), flex: 1),
