...
class SeleccionPage extends StatelessWidget {
  final SeleccionController controller = Get.find<SeleccionController>();

  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;

    return GetBuilder<SeleccionController>(
      init: controller,
      builder: (_) => Stack(
        children: [
          Scaffold(
            appBar: getAppBar('Selección', []),
            backgroundColor: secondColor,
            body: GetBuilder<SeleccionController>(
              id: 'seleccionado',
              builder: (_) => Column(
                children: [
                  ...
                  Expanded(
                    ...
                    child: RefreshIndicator(
                      ...
                      child: GetBuilder<SeleccionController>(
                        id: 'tareas',
                        builder: (_) => _.seleccions.isEmpty
                            ? EmptyDataWidget(
                                titulo: 'No existen actividades.',
                                size: size,
                                onPressed: _.getTareas)
                            : ListView.builder(
                                itemCount: _.seleccions.length,
                                itemBuilder:
                      ...
                      children: [
                        ...
                        Flexible(
                            child: Padding(
                              ...
                              child: Container(
                                color: _.seleccions[index].colorEstado,
                              ),
                            ),
                            flex: 1),
                        Flexible(child: Container(), flex: 1),
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(
                          child: Container(
                            alignment: Alignment.centerLeft,
                            child: Text(_.seleccions[index].centroCosto
                                    ?.detallecentrocosto ??
                                ''),
                          ),
                          flex: 10,
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Container(
                            alignment: Alignment.centerLeft,
                            child: Text(
                                _.seleccions[index].sede?.detallesubdivision ??
                                    ''),
                          ),
                          flex: 10,
                        ),
