...
class PesadosPage extends StatelessWidget {
  final PesadosController controller = Get.find<PesadosController>();

  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;

    return GetBuilder<PesadosController>(
      init: controller,
      builder: (_) => Stack(
        children: [
          Scaffold(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: RefreshIndicator(
                      ...
                      child: GetBuilder<PesadosController>(
                        id: 'tareas',
                        builder: (_) => _.pesados.isEmpty
                            ? EmptyDataWidget(
                                titulo: 'No existen actividades.',
                                size: size,
                                onPressed: _.getTareas)
                            : ListView.builder(
                                itemCount: _.pesados.length,
                                itemBuilder:
                      ...
                      children: [
                        ...
                        Flexible(
                            child: Padding(
                              ...
                              child: Container(
                                color: _.pesados[index].colorEstado,
                              ),
                            ),
                            flex: 1),
                        Flexible(child: Container(), flex: 1),
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(
                          child: Container(
                            alignment: Alignment.centerLeft,
                            child: Text(_.pesados[index].centroCosto
                                    ?.detallecentrocosto ??
                                ''),
                          ),
                          flex: 10,
                    ...
                    child: Row(
                        children: (_.pesados[index].estadoLocal != 'P' &&
                            ...
                            : getItemsActions(actions: [
                                ItemAction(
                                  icon: Icons.search,
                                  action: () => _.goControlLanzada(index),
                                  backgroundColor: infoColor,
                                ),
                                ItemAction(
                                  icon: Icons.check,
