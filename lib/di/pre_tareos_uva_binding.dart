...
class PreTareosUvaBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<PreTareoProcesoUvaRepository>(
        () => PreTareoProcesoUvaRepositoryImplementation());
    Get.lazyPut<ExportDataRepository>(
        () => ExportDataRepositoryImplementation());

    Get.lazyReplace<CreatePreTareoProcesoUvaUseCase>(
        () => CreatePreTareoProcesoUvaUseCase(Get.find()));
    Get.lazyReplace<GetAllPreTareoProcesoUvaUseCase>(
        () => GetAllPreTareoProcesoUvaUseCase(Get.find()));
    Get.lazyReplace<UpdatePreTareoProcesoUvaUseCase>(
        () => UpdatePreTareoProcesoUvaUseCase(Get.find()));
    Get.lazyReplace<DeletePreTareoProcesoUvaUseCase>(
        () => DeletePreTareoProcesoUvaUseCase(Get.find()));
    Get.lazyReplace<MigrarAllPreTareoUvaUseCase>(
        () => MigrarAllPreTareoUvaUseCase(Get.find()));
    Get.lazyReplace<UploadFileOfPreTareoUvaUseCase>(
        () => UploadFileOfPreTareoUvaUseCase(Get.find()));
