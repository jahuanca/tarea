...
class ListadoPersonasPesadoBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<GetAllPesadoDetallesUseCase>(
        () => GetAllPesadoDetallesUseCase(Get.find()));
    Get.lazyPut<CreatePesadoDetalleUseCase>(
        () => CreatePesadoDetalleUseCase(Get.find()));
    Get.lazyPut<DeletePesadoDetalleUseCase>(
        () => DeletePesadoDetalleUseCase(Get.find()));
    Get.lazyPut<GetEsparragoAgrupaPersonalsUseCase>(
        () => GetEsparragoAgrupaPersonalsUseCase(Get.find()));

    Get.lazyPut<ListadoPersonasPesadoController>(() =>
        ListadoPersonasPesadoController(Get.find(), Get.find(), Get.find(),
