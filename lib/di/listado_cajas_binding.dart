...
class ListadoCajasBinding extends Bindings{
  ...
  void dependencies() {
    ...
    Get.lazyPut<ClasificadoCajasRepository>(() => ClasificadoCajasRepositoryImplementation());
    ...
    Get.lazyPut<CreateClasificadoCajaUseCase>(() => CreateClasificadoCajaUseCase(Get.find()));
    Get.lazyPut<UpdateClasificadoCajaUseCase>(() => UpdateClasificadoCajaUseCase(Get.find()));
    Get.lazyPut<DeleteClasificadoCajaUseCase>(() => DeleteClasificadoCajaUseCase(Get.find()));
    Get.lazyPut<GetAllClasificadoCajasUseCase>(() => GetAllClasificadoCajasUseCase(Get.find()));

    Get.lazyPut<ListadoCajasController>(() => ListadoCajasController(Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find(), Get.find()));
