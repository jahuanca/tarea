...
class ListadoPersonasPreTareoUvaBinding extends Bindings{
  ...
  void dependencies() {
    ...
    Get.lazyPut<UpdatePreTareoProcesoUvaUseCase>(() => UpdatePreTareoProcesoUvaUseCase(Get.find()));
    Get.lazyPut<GetLaborsUseCase>(() => GetLaborsUseCase(Get.find()));

    Get.lazyPut<ListadoPersonasPreTareoUvaController>(() => ListadoPersonasPreTareoUvaController(Get.find(), Get.find(), Get.find()));
